...
//    $.getJSON('/TAMISLogin/v1/project/egp/dashboard', function(data) {
    $.getJSON('http://10.233.3.87:8090/TAMISLogin/v1/project/egp/dashboard', function(data) {
...
//    $.getJSON('/TAMISLogin/v1/project/egp/training', function(data) {
    $.getJSON('http://10.233.3.87:8090/TAMISLogin/v1/project/egp/training', function(data) {
