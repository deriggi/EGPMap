 ...
 * @author jderiggi
 */
public class EGPRenovationSitesParser extends PageParser {
    private static final Logger log = Logger.getLogger(EGPRenovationSitesParser.class.getName());
    ...
    public ArrayList<HashMap<String, String>> parsePage() {
        ...
        ArrayList<HashMap<String, String>> rowsAsMaps = convertRows(allRows, headerRow);
        
        log.log(Level.INFO,"size of renovation sites table {0} ", rowsAsMaps.size() );
